...
- ci: use commit hash for github action, add persist-credentials false [citest_skip] (#116)
- ci: refactor build_docs so that pandoc runs in isolated read-only job [citest_skip] (#117)
- ci: use exact match for systemroller instead of contains [citest_skip] (#118)
- ci(build_docs): fix pandoc container syntax [citest_skip] (#119)
- ci: [citest_skip] bump github/codeql-action from 4.37.4 to 4.37.9 (#120)
- ci: [citest_skip] bump actions/download-artifact from 7.0.0 to 8.0.1 (#121)
- ci: [citest_skip] bump codespell-project/actions-codespell from 2.1 to 2.2 (#122)
- ci: [citest_skip] bump myrotvorets/set-commit-status-action from 2774e1f040c82ed70a76b4b5cd53bb11ffaedd0a to c0f880c99d91381c6fdb97726f03feb8004409b4 (#123)
- refactor: Relax collection constraints, gate vendored modules by python version, update ci versions [citest_skip] (#124)
- ci: do not run ci tests by default, require citest comment or label [citest_skip] (#125)
- ci: replace weekly_ci with periodic_ci, stagger schedules [citest_skip] (#126)
- ci: update status when action triggered by issue comment (#127)
...
- feat: Write roles fingerprints to /var/log/sysroles.jsonl [citest_skip] (#114)

### Other Changes

- ci: bump codecov/codecov-action from 6 to 7 (#103)
- ci: bump actions/checkout from 6 to 7 (#104)
- ci: use gha checkout v7, codecov v7 [citest_skip] (#105)
- ci: Use our own pr_title_lint.py instead of NPM commitlint [citest_skip] (#106)
- ci: bump tox-lsr version to 3.20.0 to fix tox 4.58 api breakage [citest_skip] (#107)
- ci: Add support for Fedora 44 and drop Fedora 42 - use ansible-core 2.21 [citest_skip] (#109)
- ci: bump actions/setup-python from 6 to 7 (#110)
- ci: bump github/codeql-action from 4 to 4.37.3 (#111)
- ci: ensure dependabot updates do not invoke ci tests [citest_skip] (#112)
- ci: [citest_skip] bump github/codeql-action from 4.37.3 to 4.37.4 (#113)
...
- ci: bump actions/github-script from 8 to 9 (#97)
- refactor: use ansible.posix 2.1.X for EL7 compatibility [citest_skip] (#98)
- ci: Add config file for CodeRabbit with custom rules (#99)
- ci: Skip reviews for PRs with [citest_skip] in the title (#100)
- test: remove unused files [citest_skip] (#101)
...
- feat: add role fingerprints to syslog (#95)

### Other Changes

- ci: bump ansible/ansible-lint from 25 to 26 (#78)
- ci: skip most CI checks if title contains citest skip [citest_skip] (#79)
- ci: ansible-lint - remove .collection directory from converted collection [citest_skip] (#80)
- ci: tox-lsr version 3.15.0 [citest_skip] (#81)
- ci: Add Fedora 43, remove Fedora 41 from Testing Farm CI (#82)
- ci: bump actions/upload-artifact from 6 to 7 (#84)
- ci: tox-lsr 3.17.0 - container test improvements, use ansible 2.20 for fedora 43 [citest_skip] (#86)
- ci: tox-lsr 3.17.1 - previous update broke container tests, this fixes them [citest_skip] (#87)
- ci: bump codecov/codecov-action from 5 to 6 (#89)
- ci: fix yum repos to use devel site instead of old site name [citest_skip] (#90)
- ci: use codecov @v6 [citest_skip] (#91)
- ci: update header for run_role_with_clear_facts [citest_skip] (#92)
- ci: Comply with Ansible partner certification checking [citest_skip] (#93)
- ci: ansible-lint requires dependencies to be installed [citest_skip] (#94)
